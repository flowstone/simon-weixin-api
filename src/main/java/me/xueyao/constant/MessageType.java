...
public class  MessageType {
    ...
    public static final String SHORTVIDEO_MESSAGE = "shortvideo";   //小视频消息消息
    public static final String POSOTION_MESSAGE = "location";   //地理位置消息
    public static final String LINK_MESSAGE = "link";   //链接消息
    public static final String MUSIC_MESSAGE = "music";   //音乐消息
    public static final String IMAGE_TEXT_MESSAGE = "news";   //图文消息
